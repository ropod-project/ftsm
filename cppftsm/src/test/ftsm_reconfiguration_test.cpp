...
{
    class ReconfigurableComponent : public ftsm::FTSMBase
    {
    public:
        ReconfigurableComponent(std::string name, std::vector<std::string> dependencies, int max_recovery_attempts=1)
        ...
        virtual std::string running()
        {
            ...
            return ftsm::FTSMTransitions::RECONFIGURE;
        }
...
ftsm_tests::ReconfigurableComponent component("reconfiguring_component", {"component1", "component2"});
