...
{
    class FailedRecoveryComponent : public ftsm::FTSMBase
    {
    public:
        FailedRecoveryComponent(std::string name, std::vector<std::string> dependencies, int max_recovery_attempts=1)
        ...
        virtual std::string running()
        {
            ...
            return ftsm::FTSMTransitions::RECOVER;
        }
        ...
        virtual std::string recovering()
        {
            ...
            return ftsm::FTSMTransitions::FAILED_RECOVERY;
        }
    };
}

ftsm_tests::FailedRecoveryComponent component("component_that_cannot_recover", {"component1", "component2"}, 3);
